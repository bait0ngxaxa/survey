        ...
        <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-50 via-white to-sky-50/30 selection:bg-sky-100 selection:text-sky-900 font-sans overflow-hidden">
            ...
            <main className="relative z-10 flex flex-col items-center justify-start grow px-6 pb-10 pt-2 md:pt-4 text-center">
                ...
                <div className="w-full max-w-4xl mx-auto flex flex-col items-center gap-8 animate-in slide-in-from-bottom-5 fade-in duration-1000">
                    ...
                    <div className="relative w-56 h-56 md:w-72 md:h-72 mb-4 group">
                        {/* Outer glow ring */}
                        <div className="absolute inset-[-20%] bg-gradient-to-br from-sky-200/20 via-blue-100/10 to-cyan-200/20 rounded-full blur-3xl animate-[pulse_6s_ease-in-out_infinite]" />

                        {/* Middle glow */}
                        <div className="absolute inset-[-10%] bg-sky-100/40 blur-2xl rounded-full animate-[pulse_4s_ease-in-out_infinite_0.5s]" />

                        {/* Inner glow */}
                        <div className="absolute inset-0 bg-gradient-to-br from-white/80 to-sky-50/60 rounded-full blur-xl" />
                    ...
                    <div className="space-y-6 max-w-3xl">
                        <h1 className="text-3xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.1]">
                            ...
                            <span className="block mt-3 text-transparent bg-clip-text bg-gradient-to-r from-sky-500 via-blue-500 to-cyan-500 drop-shadow-sm animate-[shimmer_3s_ease-in-out_infinite]">
                                เครื่องมือ PROMs
                            </span>
                        </h1>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full pt-4">
                        <SignedIn>
                            ...
                            >
                                ...
                                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-gradient-to-r from-sky-500 via-blue-500 to-cyan-500 transition-opacity duration-300" />
                        ...
                        <SignedOut>
                            <SignInButton forceRedirectUrl="/dashboard?loggedIn=true">
                                <button className="group relative inline-flex items-center justify-center min-w-[220px] px-8 py-4 text-lg font-bold text-white transition-all duration-300 overflow-hidden rounded-full focus:outline-none focus:ring-4 focus:ring-sky-100/50">
                                    ...
                                    <div className="absolute inset-[-2px] bg-gradient-to-r from-sky-400 via-blue-400 to-cyan-400 rounded-full opacity-0 group-hover:opacity-60 blur-sm transition-opacity duration-300" />
                                    <div className="absolute inset-0 bg-gradient-to-r from-sky-500 via-blue-500 to-cyan-500 rounded-full" />
