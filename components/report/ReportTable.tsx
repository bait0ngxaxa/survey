...
export function ReportTable({ reportData }: ReportTableProps) {
    ...
    return (
        <div className="proms-panel rounded-2xl p-4 sm:p-8 print:border-none print:p-0">
            <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center gap-3 print:hidden thai-text">
                <span className="proms-primary-gradient p-2 rounded-lg">
            ...
            <div className="overflow-x-auto rounded-xl border border-gray-200 print:border-black print:rounded-none">
                <table className="w-full text-left text-sm text-gray-600 border-collapse min-w-[600px]">
                    <thead
                        className="proms-header-gradient text-gray-900 font-semibold text-center print:bg-sky-100"
                        style={
                            {
