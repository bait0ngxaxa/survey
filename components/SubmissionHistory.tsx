...
function getRegionInfo(regionId: string) {
    ...
    return region || { name: regionId, color: "bg-gray-500" };
}
...
export default function SubmissionHistory({
    ...
    if (submissions.length === 0) {
        return (
            <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 p-8">
    ...
    return (
        <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
            {/* Header */}
            <button
